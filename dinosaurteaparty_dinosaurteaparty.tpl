...
var jstpl_dinosaur_tooltip = '<div id="dino_${DINOSAUR_ID}_tooltip" class="dtp_placeholder dinosaurtooltip dinosaurtooltip${DINOSAUR_ID} "> </div><div>${TOOLTIP_TEXT}</div>';
